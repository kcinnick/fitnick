...
EXPECTED_DAILY_ACTIVITY_RESPONSE = {'activities': [{'activityId': 20049,
                ...
                {'activityId': 20049,
                 ...
                 'hasStartTime': True,
                 'isFavorite': False,
                 'lastModified': '2020-12-24T17:03:52.000Z',
                 'logId': 36487795727,
                 'name': 'Treadmill',
                 'startDate': '2020-12-24',
                 'startTime': '11:37',
                ...
                {'activityId': 20049,
                 ...
                 'hasStartTime': True,
                 'isFavorite': False,
                 'lastModified': '2020-12-24T19:19:52.000Z',
                 'logId': 36489026309,
                 'name': 'Treadmill',
                 'startDate': '2020-12-24',
                 'startTime': '13:50',
                ...
                {'activityId': 20049,
                 ...
                 'hasStartTime': True,
                 'isFavorite': False,
                 'lastModified': '2020-12-25T00:32:21.000Z',
                 'logId': 36489666573,
                 'name': 'Treadmill',
                 'startDate': '2020-12-24',
                 'startTime': '19:01',
                ...
                {'activityId': 20049,
                 ...
                 'hasStartTime': True,
                 'isFavorite': False,
                 'lastModified': '2020-12-25T04:01:25.000Z',
                 'logId': 36489745633,
                 'name': 'Treadmill',
                 'startDate': '2020-12-24',
                 'startTime': '22:17',
                 'steps': 3502}],
 'goals': {'activeMinutes': 70,
           'caloriesOut': 3100,
           'distance': 9.66,
           'floors': 10,
           'steps': 12000},
 'summary': {'activeScore': -1,
             'activityCalories': 1204,
             'caloriesBMR': 1804,
             'caloriesOut': 2861,
             'distances': [{'activity': 'Treadmill', 'distance': 0.577838},
                           {'activity': 'Treadmill', 'distance': 1.178393},
                           {'activity': 'Treadmill', 'distance': 0.492319},
                           {'activity': 'Treadmill', 'distance': 0.754637},
                           {'activity': 'Treadmill', 'distance': 1.671799},
                           {'activity': 'total', 'distance': 5.73},
                           {'activity': 'tracker', 'distance': 5.73},
                           {'activity': 'loggedActivities',
                            'distance': 4.6749860000000005},
                           {'activity': 'veryActive', 'distance': 3.58},
                           {'activity': 'moderatelyActive', 'distance': 0.76},
                           {'activity': 'lightlyActive', 'distance': 1.38},
                           {'activity': 'sedentaryActive', 'distance': 0}],
             'elevation': 120,
             'fairlyActiveMinutes': 18,
             'floors': 12,
             'heartRateZones': [{'caloriesOut': 2477.50401,
                                 'max': 96,
                                 'min': 30,
                                 'minutes': 1372,
                                 'name': 'Out of Range'},
                                {'caloriesOut': 348.86304,
                                 'max': 134,
                                 'min': 96,
                                 'minutes': 46,
                                 'name': 'Fat Burn'},
                                ...
                                {'caloriesOut': 0,
                                 ...
                                 'minutes': 0,
                                 'name': 'Peak'}],
             'lightlyActiveMinutes': 141,
             'marginalCalories': 719,
             'restingHeartRate': 64,
             'sedentaryMinutes': 703,
             'steps': 12053,
